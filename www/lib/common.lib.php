...
function PushSend($tokens, $deviceType, $title, $body,  $link) {

    $to = '"registration_ids":["'.$tokens.'"]';
    $curl = curl_init();
    if($deviceType == 'a') {
       curl_setopt_array($curl, array(
          ...
          CURLOPT_HTTPHEADER => array(
             ...
             'Authorization: key=AAAAVuFB74c:APA91bEDpbwtaC0bI7mtm3tMkSGTFtBSFKqkAoajZho8UhgGXP7krOJoRYpz75S8PpS07qbKeaAkF7a2IPPiRfzs9Hw29NIrbN_jLTPtt68IiUU3OYl0Fl-YEaApAIRtrm_uf8-J_Kts'
          ),
       ));
