...
<section class="myh">
    <div class="pd15">
        ...
        <form method = "post" action = "./myh_2_ok.php">
                ...
                <div class="t_con">
                    <div class="tr">
                        <div class="td td1 vt_mid">
                            <input type="radio" name="self_ck" id="self1" class="radio" value = '격렬하게 운동하거나 일을 할 때 숨이 차다.' checked>
                        </div>
                    ...
                    <div class="tr">
                        <div class="td td1 vt_mid">
                            <input type="radio" name="self_ck" id="self2" value = "평지를 빨리 걷거나 언덕을 올라갈 때 숨이 차다." class="radio">
                        </div>
                        <div class="border vt_mid">
                            <div class="td td2 vt_mid">
                    ...
                    <div class="tr">
                        <div class="td td1 vt_mid">
                            <input type="radio" name="self_ck" id="self3" value = "평지를 걸을 때 숨이 차서 동년배 사람들보다 천천히 걸어야 하거나 본인의 평소 속도로 걷기 위해서는 중간에 쉬어야 한다." class="radio">
                        </div>
                        <div class="border vt_mid">
                            <div class="td td2 vt_mid">
                    ...
                    <div class="tr">
                        <div class="td td1 vt_mid">
                            <input type="radio" name="self_ck" id="self4" value = "평지를 100m 정도 걷거나 2-3분만 걸어도 숨이 차서 쉬어야 한다." class="radio">
                        </div>
                        <div class="border vt_mid">
                            <div class="td td2 vt_mid">
                    ...
                    <div class="tr">
                        <div class="td td1 vt_mid">
                            <input type="radio" name="self_ck" id="self5" value = "숨이 차서 외출하기 어렵거나 옷을 입고 벗을 때조차도 숨이 차다." class="radio">
                        </div>
                        <div class="border vt_mid">
                            <div class="td td2 vt_mid">
            ...
            <div class="btn_fixed">
                <button type="submit" class="next_btn on">저장</button>
            </div>
        </form>
    </>
</section>
