	    ...
	    <div class="register_form_inner">
	        ...
	        <ul>
	            ...
	            <li class="half_input left_input margin_input">
	                ...
	                <input type="password" name="mb_password" id="reg_mb_password" value="<?php echo $member['mb_password'] ?>" <?php echo $required ?> class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="비밀번호">
	            </li>
	            <li class="half_input left_input">
	                <label for="reg_mb_password_re">비밀번호 확인 (필수)</label>
	                <input type="password" name="mb_password_re" id="reg_mb_password_re" value="<?php echo $member['mb_password'] ?>" <?php echo $required ?> class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="비밀번호 확인">
	            </li>
	        </ul>
	    </div>
