...
<section class="comm tg_sc">
    <div class="pd15">
        <div class="input_wrap">
            ...
            <input type="text" name="search" id="search" class="s_input" onBlur="searchGo()" placeholder="검색어를 입력하세요.">

            <button type="button" class="reset" onclick="searchAreaDefault()">
