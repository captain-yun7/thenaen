    ...
    <form name="info">
        <div class="pd15">
            ...
            <div class="dis_wrap">
                ...
                <input type="text" name="dis" id="diss" class="input" placeholder="진단명" onkeydown="buttonActiveJoin()">
                <div class="red">2글자 이상 입력해주세요.</div>
            </div>
        </div>

        <div class="btn_fixed">
            <button type="button" id = "next_btn_id_info2" class="next_btn">다음</button>
        </div>
    </form>
</section>
...
<script>
    ...
    function buttonActiveJoin(){
        ...
        if (dis != "") {
            $("#next_btn_id_info2").addClass("on");
        }
        else{
            $("#next_btn_id_info2").remove("on");
        }
