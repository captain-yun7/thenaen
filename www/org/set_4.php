    ...
    <div class="pd15">
        ...
        <div class="tab">
            <div class="des_div">
                ...
                제 1 조 (목적)<br>
                본 약관은 ‘더나은호흡’이 운영하는 웹 사이트 (http://xxx.xxx.xxx)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.<br><br>
                ...
                제 16 조 (정보의 변경)<br>
                이용자는 주소, 비밀번호 등 고객정보를 변경하고자 하는 경우에는 어플리케이션의 정보 변경 서비스를
                이용하여 변경할 수 있다.<br><br>

                제 17 조 (계약사항의 해지)<br>
                이용자는 서비스 이용계약을 해지할 수 있으며, 해지할 경우에는 본인이 직접 서비스를 통하거나 어플리케이션의 탈퇴신청을 해야한다. 사이트는 해지신청이 접수된 당일부터 해당 이용자의 서비스 이용을 제한한다. 사이트는 이용자가 다음 각 항의 1에 해당하여 이용계약을 해지하고자 할 경우에는 해지조치 7일전까지 그 뜻을 이용자에게 통지하여 소명할 기회를 주어야 한다.<br>
