...
<script>
    ...
    function buttonActiveJoin(){
        ...
        if (nickname != "") {
            $("#next_btn_id_info3").addClass("on");
        }
        else{
            $("#next_btn_id_info3").remove("on");
        }
...
<section class="j_info ji3">
    <form name="info">
        <div class="pd15">
            ...
            <div class="i_block">
                ...
                <div class="input_wrap">
                    <input type="text" name="nickname" id="nickname" class="input" placeholder="한글로 된 닉네임을 입력하세요." onkeydown="buttonActiveJoin()">
        ...
        <div class="btn_fixed">
            <button type="button" id = "next_btn_id_info3" class="next_btn">완료하고 더나은호흡 시작</button>
        </div>
    </form>
</section>
