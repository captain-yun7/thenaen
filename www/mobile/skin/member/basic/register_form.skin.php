...
<div class="register">
    ...
    <input type="hidden" name="cert_no" value="">
        ...
        <input type="hidden" name="age" id = "age" value="<?=$member['age']?>">
        <input type="hidden" name="height" id = "height"  value="<?=$member['height']?>">
        <input type="hidden" name="weight" id = "weight"  value="<?=$member['weight']?>">
        <input type="hidden" name="heart_rate" id = "heart_rate"  value="<?=$member['heart_rate']?>">
        <input type="hidden" name="disease" id = "disease"  value="<?=$member['disease']?>">
        <input type="hidden" name="certification" id = "certification" value="<?=$member['certification']?>">

        <input type="hidden" name="varjavauser_nick" id = "varjavauser_nick" value="<?=$member['varjavauser_nick']?>">
        <input type="hidden" name="varjavauser_email" id = "varjavauser_email" value="<?=$member['varjavauser_email']?>">
        <input type="hidden" name="varjavauser_id" id = "varjavauser_id" value="<?=$member['varjavauser_id']?>">
        <input type="hidden" name="varjavauser_phone" id = "varjavauser_phone" value="<?=$member['varjavauser_phone']?>">
    ...
    <div class="form_01">
        ...
        <ul>
	        ...
	        <li class="password">
	            ...
	            <input type="password" name="mb_password" id="reg_mb_password" value="<?php echo $member['mb_password'] ?>" class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" <?php echo $required ?> placeholder="비밀번호 (필수)">
	        </li>
	        <li>
	            <label for="reg_mb_password_re" class="sound_only">비밀번호확인 (필수)</label>
	            <input type="password" name="mb_password_re" id="reg_mb_password_re" value="<?php echo $member['mb_password'] ?>" class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" <?php echo $required ?>  placeholder="비밀번호확인 (필수)">
	        </li>
        </ul>
    </div>
